...
# Step 8: Launch Random Boats Spawner (Optional - requires ROS environment)
echo -e "${YELLOW}8️⃣  Random Boats Spawner (Optional)${NC}"
echo -e "${YELLOW}   To start random boats, run in a separate terminal:${NC}"
echo -e "${YELLOW}   cd ~/final_stand/vrx/dashboard && ./start_random_boats_manual.sh${NC}"
echo ""

# Step 9: Open Browser
echo -e "${YELLOW}9️⃣  Opening Dashboard in Browser...${NC}"
sleep 2
...
echo "  Random Boats: $RANDOM_BOATS_PID"
echo ""
...
echo "  Random Boats: /tmp/random_boats.log"
echo ""
